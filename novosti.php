                ...
                <div class="row">
                    <div class="novosti col-12 text-center">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#New">Новые</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#Popular">Популярные</a>
                            </li>
                        </ul>

                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div class="tab-pane active container" id="New">
                                <div class="row">
                                <div class="lenta col-9">
                                    <!--1 Новость -->
                                        ...
                                        <div class="zapis col-sm-12  col-md-12 col-lg-12 col-xl-12 text-left">
                                            <a class="zap" href="#">
                                                <div class="row">
                                                    ...
                                                    <div class="zagolovok col-lg-9">
                                                        <h3>А это не новая новость "notHELLO NEWS"</h3>
                                                ...
                                                <div class="row">
                                                    <!-- тут короче фотография вставляется на всю свою ширину и висота ставится автоматически-->
                                                    <div class="imgzapisi img-fluid col-12"><img src="images/tel.png" alt="tel" >
                                                    </div>
                                                </div>
                                            </a>
                                            <div class="previewtext">
...
<div class="col-1 pr" ></div>
                                <div class="podpiski col-2">
                                    <h3>Подписки </h3>
                                    <div class="spisokavtorov">
                                       <div class="imageavt">
                                        <img src="images/gal.PNG" alt="ava" height="50" width="50">
                            ...
                            <div class="tab-pane container" id="Popular">
                                <div class="lenta col-10 text-left">
                                <!--2 Новость -->
                                <div class="row">
                                    <div class="zapis col-sm-12  col-md-12 col-lg-12 col-xl-12 text-left">
                                        <a class="zap" href="#">
