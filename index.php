...
<div class="fon">
 ...
 <div class="header">
  ...
  <div class="container-fluid">
      ...
      <div class="col-sm-2" id="log">Арт-витрина</div>
    <div id="links" class="col-xs-6 col-md-6 col-lg-6">
        ...
        <a href="#">Сообщество</a>
          ...
          <div class="test col-xs-2 col-md-2 col-lg-2">
        <!--search form-->
 ...
 <!--Форма регистрации -->
      ...
      <div id="registr" class="modal fade" tabindex="-1">
          ...
          <?php else: ?>
    <div class="cabinet col-xs-2 col-md-2 col-lg-2">
